	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Add Weakly Report</h4>
						<div class="row container mt-5 d-flex justify-content-center">
						<?php if (isset($_GET['message'])): ?>
							<div style="color: green; font-weight: bold;">
								<a href="view_reports.php" style="text-decoration: none; color: green;">
									<?php echo htmlspecialchars($_GET['message']); ?>
								</a>
							</div>
						<?php endif; ?>

                        <form class="col-md-8" method="POST" action="../../Back/addReport.php"> <!-- Make sure the action points to the correct PHP file -->
						<div class="form-group">
							<label for="type">Type</label>
							<select class="form-control" id="type" name="Reporttype" required>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="subject" name="Reportsubject" placeholder="Enter subject" required>
						</div>
						<div class="form-group">
							<label for="details">Details</label>
							<textarea class="form-control" id="myTextarea" name="detail" rows="4" placeholder="Enter details" required></textarea>
						</div>
...
<script>
    // tinymce.init({
    //     selector: '#myTextarea', // Targeting the textarea
    //     plugins: 'lists link image table code', // Available plugins
    //     toolbar: 'undo redo | styles | bold italic | alignleft aligncenter alignright | bullist numlist outdent indent | link image | code', // Toolbar options
	...
	tinymce.init({
        ...
        setup: function (editor) {
            // Automatically update the textarea value on form submission
            editor.on('change', function () {
                editor.save(); // Save changes back to the textarea
            });
        }
    });
</script>
