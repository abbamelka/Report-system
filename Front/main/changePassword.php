			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
                        ...
                        <form class="col-md-8" action="../../Back/changepass.php" method="POST">
                            <label>
                                <?php
                         ...
                         <div class="form-group">
                            ...
                            <input class="form-control" type="password" name="current_password" id="current_password" required><br>
                         </div>  
                         <div class="form-group">
                            <label for="new_password">New Password:</label>
                            <input class="form-control" type="password" name="new_password" id="new_password" required><br>
                         </div>
                         <div class="form-group">
